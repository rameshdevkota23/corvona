...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Recent post', 'corvona'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Tags', 'corvona'); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo esc_html__('Categories', 'corvona'); ?></h4>
<!-- /wp:heading -->
