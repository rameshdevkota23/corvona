...
class Corvona_Admin_Info
{
    ...
    {
        add_theme_page(
            esc_html__('corvona Theme', 'corvona'),
            esc_html__('corvona Theme', 'corvona'),
            'edit_theme_options',
            'corvona',
    ...
    public function check_rt_easy_builder_freemius()
    {
        if (function_exists('RT_Easy_Builder\rt_freemius') && ! RT_Easy_Builder\rt_freemius()->is_not_paying()) {
            ...
            add_action('wp_ajax_dismiss_corvona_notification', array($this, 'dismiss_notification_ajax_handler'));
        }
    }
    ...
    {
        delete_transient('corvona_notification_dismissed');
    }
    ...
    public function compatible_check()
    {
        ...
        $dismissed = get_option('corvona_notification_dismissed');
        if (!$dismissed) {
    ...
    public function dismiss_notification()
    {
        ...
        update_option('corvona_notification_dismissed', true);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_corvona_notification',
...
// Instantiate the corvona Admin Info class
new Corvona_Admin_Info();
